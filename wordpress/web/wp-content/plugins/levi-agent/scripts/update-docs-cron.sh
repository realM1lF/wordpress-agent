...
# Cron wrapper: Update WordPress, WooCommerce & Elementor developer documentation.
#
...
echo "" | tee -a "$LOGFILE"
echo "--- Elementor Docs ---" | tee -a "$LOGFILE"
python3 "$SCRIPT_DIR/fetch_elementor_docs.py" 2>&1 | tee -a "$LOGFILE"
