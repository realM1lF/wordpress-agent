...
class ReadTool extends AbstractTool
{
    ...
    public function getParameters(): array
    {
        return [
            ...
            "path" => [
                "type" => "string",
                "description" =>
                    "Pfad zur Datei (für type=file). Absolut oder relativ zu wp-content/",
            ],
            "id" => [
                "type" => "integer",
            ...
            "slug" => [
                "type" => "string",
                "description" =>
                    "Post-Slug oder Benutzer-Login (Alternative zu id)",
            ],
            "name" => [
                "type" => "string",
            ...
            "start_line" => [
                "type" => "integer",
                "description" =>
                    "Erste Zeile (1-basiert, optional, für Dateien)",
            ],
            "end_line" => [
                "type" => "integer",
            ...
            "fields" => [
                ...
                "items" => ["type" => "string"],
                "description" =>
                    'Nur diese Felder zurückgeben (z.B. ["post_title","post_content"])',
            ],
        ];
    }
    ...
    private function readPost(string $type, array $params): array
    {
        ...
        if (!empty($params["id"])) {
            ...
            return [
                "success" => false,
                "error" => "Erforderlich: id oder slug",
            ];
        }
        ...
        if (!$post instanceof \WP_Post) {
            return [
                "success" => false,
                "error" => ucfirst($type) . " nicht gefunden",
            ];
        }
    ...
    private function readUser(array $params): array
    {
        if (!empty($params["id"])) {
            ...
            return [
                "success" => false,
                "error" => "Erforderlich: id, email oder slug",
            ];
        }
